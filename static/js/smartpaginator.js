    ...
    $.fn.extend({
        smartpaginator: function(options) {
            ...
            return this.each(function() {
                ...
                var inputPage = $('<input/>').attr('type', 'text').css('background-color','#fff').keydown(function(e) {
...
//                    } else if (!(e.which == 8 || e.which == 46)) e.preventDefault();                    
                ...
                function showLabels(pageIndex) {
                	if (settings.showLabel == 'yes') {                		
                        ...
                        container.append($('<span/>').append($('<p/>').text(pageIndex * settings.recordsperpage + 1)))
                                                 .append($('<span/>').text('-'))
                                                 .append($('<span/>').append($('<p/>').text(upper)))
                                                 .append($('<span/>').text('of'))
                                                 .append($('<span/>').append($('<p/>').text(settings.totalrecords)));
                	}                    
                }
